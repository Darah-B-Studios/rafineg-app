...
function ProfileNavigator() {
  return (
    <ProfileStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <ProfileStack.Screen name="EditPersonalInfoScreen" component={EditPersonalInfoScreen} />
...
function TransactionsNavigator() {
  return (
    <TransactionsStack.Navigator
      initialRouteName="Transactionss"
    ...
    >
      ...
      <DrawerNav.Screen
        ...
        options={({ route }) => {
          ...
          if (routeName == "PackageDetails") return { swipeEnabled: false };
        }}
      />
      <DrawerNav.Screen
        name="Referrals"
        ...
        options={({ route }) => {
          ...
          if (routeName == "Withdraw") return { swipeEnabled: false };
        }}
      />
      <DrawerNav.Screen
        name="Transactions"
        ...
        options={({ route }) => {
          ...
          if (routeName == "TransactionDetails") return { swipeEnabled: false };
        }}
      />
      <DrawerNav.Screen
        name="Profile"
        ...
        options={({ route }) => {
          ...
          if (routeName == "EditProfile") return { swipeEnabled: false };
        }}
      />
